defmodule DemoWeb.Helpers.NewCodeFormat do
  @moduledoc """
  Helpers to format a FlyMapEx.node_map call as a code example, and assemble the same into a real call.
  """

  use Phoenix.Component

  @doc """
  Renders the code for a FlyMapEx component invocation from the assigns you'd pass to FlyMapEx.node_map.
