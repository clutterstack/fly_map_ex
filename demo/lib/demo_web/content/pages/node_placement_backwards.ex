defmodule DemoWeb.Content.NodePlacementBackwards do
  @moduledoc """
  ...
  def doc_metadata do
    %{
      title: "NodePlacementBackwards Module",
      description: "This is a content module ",
      template: "StageTemplateBackwards"
    }
  end
  ...
  def tabs do
    [
      %{
        ...
        # content: get_content("by_coords").content,
      },
      %{
        key: "fly_regions",
        label: "Fly.io regions",
        # content: get_content("fly_regions").content
      },
      %{
        key: "custom_regions",
        label: "Custom Regions",
        # content: get_content("custom_regions").content
      },
      %{
        key: "multiple",
        label: "Multiple",
        # content: get_content("multiple").content
      }
    ]
  end
