defmodule DemoWeb.Stage4Live do
  ...
  defp update_marker_groups(socket) do
    marker_groups = case socket.assigns.current_demo do
  ...
  def render(assigns) do
    assigns = assign(assigns, :code_examples, %{
      "color_cycling" => """
    ...
    <div class="container mx-auto p-8">
      ...
      <div class="mb-6">
        <div class="flex flex-wrap gap-2">
          <button 
            class={["btn", if(@current_demo == "color_cycling", do: "btn-primary", else: "btn-outline")]}
          ...
          <button 
            class={["btn", if(@current_demo == "brand_integration", do: "btn-primary", else: "btn-outline")]}
            phx-click="demo_change"
          ...
          <button 
            class={["btn", if(@current_demo == "animation_showcase", do: "btn-primary", else: "btn-outline")]}
            phx-click="demo_change"
          ...
          <button 
            class={["btn", if(@current_demo == "custom_builder", do: "btn-primary", else: "btn-outline")]}
            phx-click="demo_change"
        ...
        <div class="space-y-4">
              ...
              <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <div class="space-y-2 text-sm">
                  <div class="flex items-center space-x-2">
                    ...
                    <span class="text-green-700"><strong>:pulse</strong> - Radius + opacity (health status)</span>
                  </div>
                  <div class="flex items-center space-x-2">
                    <div class="w-3 h-3 rounded-full animate-bounce bg-amber-500"></div>
                    <span class="text-green-700"><strong>:bounce</strong> - Complex bounce (critical alerts)</span>
                  </div>
                  <div class="flex items-center space-x-2">
                    <div class="w-3 h-3 rounded-full bg-blue-500" style="animation: fade 3s infinite;"></div>
                    <span class="text-green-700"><strong>:fade</strong> - Opacity only (background activity)</span>
                  </div>
                  <div class="flex items-center space-x-2">
                    <div class="w-3 h-3 rounded-full bg-emerald-500"></div>
                    <span class="text-green-700"><strong>static</strong> - No animation (stable state)</span>
                  </div>
                </div>
              </div>
          ...
          <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
            ...
            <ul class="text-gray-700 text-sm space-y-1">
              <li>• <strong>Semantic First:</strong> Use operational(), warning(), danger() when data has meaning</li>
              <li>• <strong>Color Cycling:</strong> Use cycle() for multiple groups without semantic significance</li>
              <li>• <strong>Custom Styling:</strong> Use custom() for brand colours and specific requirements</li>
              <li>• <strong>Accessibility:</strong> Ensure sufficient contrast and don't rely only on colour</li>
              <li>• <strong>Performance:</strong> Limit animations to critical states that need attention</li>
            </ul>
          </div>
        </div>
      </div>
