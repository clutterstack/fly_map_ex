defmodule FlyMap.Components.WorldMap do
  @moduledoc """
  SVG world map component for displaying Fly.io regions with different marker types.
  
  Renders an interactive SVG world map with configurable markers, colors, and animations.
  """
  ...
  * `id` - HTML id for the SVG element (default: "fly-region-map")
  ...
  def render(assigns) do
    ...
    >
      ...
      <.world_map_paths colors={@colors} />
      
      <!-- Map borders -->
      <path d={@toppath} stroke={@colors.border} stroke-width="1" />
      <path d={@btmpath} stroke={@colors.border} stroke-width="1" />
  ...
  # World map SVG paths component 
  defp world_map_paths(assigns) do
    ~H"""
    <!-- Ocean background -->
    <g id="ocean">
      <path
